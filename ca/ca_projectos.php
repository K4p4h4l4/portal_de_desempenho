...
<body>
    ...
    <section class="content">
        <div class="container3">
            <div class="tab__buttons">
                <button id="matriz" class="tab tab__selected" type="button"><i class="material-icons">list</i> Matriz Geral de Acompanhamento</button>
                <button id="analise" class="tab" type="button"><i class="material-icons">find_in_page</i> Projectos em Análise</button>
                <button id="conclusao" class="tab" type="button"><i class="material-icons">done</i>Projectos para Conclusão</button>
            </div>
        </div>
        <?php include('../includes/ca_projectos_body.php'); ?>
    </section>
        ...
        <div class="modal-content">
            <form action="../includes/insert_data.php" enctype="multipart/form-data" method="post" id="form_addProject">
                ...
                <div class="tab__content">
                    <div class="content__tabs" id="content11">
                        <div class="data_box">
                    ...
                    <div class="content__tabs" id="content22">
                        <div class="data_box">
                            <div class="task__label">
                    ...
                    <div class="content__tabs" id="content33">
                        <div class="data_box">
                            <div class="task__label">
                    ...
                    <div class="content__tabs" id="content44">
                        <div class="data_box">
                            <div class="task__label">
                    ...
                    <div class="content__tabs" id="content55">
                        <div class="data_box">
                            <div class="task__label">
                    ...
                    <div class="content__tabs" id="content66">
                        <div class="data_box">
                            <div class="task__label">
    ...
    <div class="modal-update-projecto">
        <div class="modal-content">
            <form action="../includes/update_data.php" enctype="multipart/form-data" method="post">
                ...
                <div class="tab__content">
                    <div class="content__tabs" id="contentUpdt1">
                        <div class="data_box">
                            <div class="task__label">
                                <span>Nome</span>
                            </div>
                    ...
                    <div class="content__tabs" id="contentUpdt2">
                        <div class="data_box">
                            <div class="task__label">
                                <span>Missão e Âmbito</span>
                            </div>
                    ...
                    <div class="content__tabs" id="contentUpdt3">
                        <div class="data_box">
                            <div class="task__label">
                                <span>Metodologia</span>
                            </div>
                    ...
                    <div class="content__tabs" id="contentUpdt4">
                        <div class="data_box">
                            <div class="task__label">
                                <span>Riscos do Projecto</span>
                            </div> 
                    ...
                    <div class="content__tabs" id="contentUpdt5">
                        <div class="data_box">
                            <div class="task__label">
                                <span>Equipa do Projecto</span>
                            </div>
                    ...
                    <div class="content__tabs" id="contentUpdt6">
                        <div class="data_box">
                            <div class="task__label">
                                <span>Cronograma</span>
                            </div>
    ...
    <script src="../js/ca_projectos.js"></script> 
