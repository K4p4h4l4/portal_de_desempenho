...
<div class="dashboard">
    ...
    <div class="box">
        <ul class="list">
            <li class="list--item"><a href="media_noticias"><i class="far fa-newspaper"></i><span class="list__links">Notícias</span></a></li>
            <li class="list--item"><a href="media_saude"><i class="material-icons">favorite</i><span class="list__links">Saúde</span></a></li>
            <li class="list--item"><a href="media_contactos"><i class="material-icons">contact_phone</i><span class="list__links">Contactos</span></a></li>
            <li class="list--item"><a href="media_profile"><i class="material-icons md-white">person</i><span class="list__links">Perfil</span></a></li>
        </ul>
    </div>
</div>
