...
<body>
   <?php include('../includes/dashboard_rh.php'); ?>
    ...
    <section class="conteudo">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                   <?php
                    ...
                    ?>
                    <tr>
                        <td style="text-align:center;" class=""><?php echo $qt;?></td>
                        <td class=""><?php echo $user_name." ".$user_surname;?></td>
                        <td style="text-align:center;" class=""><?php echo $user_email
                            ;?></td>
                        <td style="text-align:center;" class=""><?php echo $user_contact
                            ;?></td>          
        ...
        <?php  if($qt <= 8){
                    $output = "<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>";
                    echo $output;
                } 
        ?>
    </section>
