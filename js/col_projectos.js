    ...
    ********************************************/
    ...
    /**********************************
    *Função para adicionar funções de visualizar*
    *quando passa-se para a outra parte da tabela*
    *la     
    ********************************************/
    function add_action(){
        btn_view_project = document.querySelectorAll('.btn-view-project');
        btn_open_comment_modal = document.querySelectorAll('.btn-open-comment-modal');
        open_comments = document.querySelectorAll('.btn-view-project-comments');
        open_updtProject = document.querySelectorAll(".btn-open-updtProject");
